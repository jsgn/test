...
class ReferenceField(BaseField):
    ...
    def validate(self, value):
        assert isinstance(value, (self.document_type, DBRef))
...
class FileField(BaseField):
    ...
    def __get__(self, instance, owner):
        ...
        if self.grid_file:
            ...
            self.grid_file = GridFSProxy()
            instance._data[self.name] = self.grid_file
        return self.grid_file
    ...
    def validate(self, value):
        if value.grid_id is not None:
            ...
            assert isinstance(value.grid_id, ObjectId)
