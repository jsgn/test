...
class QuerySet(object):
    ...
    def __init__(self, document, collection):
        ...
        self._query_obj = Q()
        self._initial_query = OrderedDict()
        ...
        if document._meta.get('allow_inheritance') and (self._document._class_name in ['RootDocument.EdgarFiling','RootDocument.Transcript','RootDocument.Presentation','RootDocument.NewsItem','RootDocument.ArticleItem','RootDocument.TweetDocument'] or 'UserActivity.' in self._document._class_name):
            #self._initial_query = {'_types': {'$in':[self._document._class_name]}}
    ...
    def _query(self):
        if self._mongo_query is None:
            ...
            if 'll' not in self._mongo_query.keys():
    ...
    def ensure_index(self, key_or_list, drop_dups=False, background=False,
        **kwargs):
        ...
        return self
        # Todo: Remove ensure index from sentieolib.mongoengine
